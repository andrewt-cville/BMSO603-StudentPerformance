...
This logistic model includes the independent variables that were deemed statistically significant
from the previous model. We define statistical significance as variables that have a
