---
title: "Project_llekkala_GPA(removed)"
...
ggplot(Student_performance_data, aes(x = GradeClass)) + 
  geom_bar() +
  theme_minimal() +
  ggtitle("Distribution of Grade Classes")

# Visualize relationships between remaining predictors
ggplot(Student_performance_data, aes(x = StudyTimeWeekly, y = as.numeric(GradeClass))) + geom_point() + theme_minimal() + ggtitle("Study Time Weekly vs GradeClass")

ggplot(Student_performance_data, aes(x = Age, y = as.numeric(GradeClass))) + geom_point() + theme_minimal() + ggtitle("Age vs GradeClass")

ggplot(Student_performance_data, aes(x = Gender, y = as.numeric(GradeClass))) + geom_boxplot() + theme_minimal() + ggtitle("Gender vs GradeClass")
...
# Random Forest Model
# Set mtry to the default value for classification
...
# KNN
# Ensure you exclude the 'GradeClass' column for the KNN model, assuming it's the last column
